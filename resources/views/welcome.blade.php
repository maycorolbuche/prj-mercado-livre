    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Integração Mercado Livre</h1>
                <p class="mb-2 text-[#706f6c]">Por <a href="https://maycorolbuche.com.br/" target="_blank">Mayco
                        Rolbuche</a></p>
                <p class="mb-2 text-[#706f6c]">Utilize os botões acima para fazer login/se registrar!</p>
